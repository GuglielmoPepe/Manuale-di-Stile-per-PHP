...
* [I files sorgente **DEVONO** essere aperti dal tag PHP esteso `* [Il tag di chiusura **DEVE** essere omesso nei files sorgente](#il-tag-di-chiusura-deve-essere-omesso-nei-files-sorgente)
* [Nei files che mescolano PHP e HTML **DEVONO** essere usati i tag estesi ``](#nei-files-che-mescolano-php-e-html-devono-essere-usati-i-tag-estesi-)
